...
![Dernière Version](https://img.shields.io/badge/version-4.8.0.5-blue)
...
1.  Téléchargez le fichier `.zip` depuis la page [Releases](https://github.com/peterdu1109/NotifySync/releases/tag/4.8.0.5).
