...
* **📱 Compatibilité :** Fonctionne sur PC (Windows/Linux) & Mac et applications mobiles (Android/Iphone).
* **(Note : Ne fonctionne pas sur les interfaces TV comme Android TV, Apple TV, Tizen, etc).**
